...
from utils.image_utils import psnr, ssim, lpips
    ...
    for iteration in range(first_iter, opt.iterations + 1):
        ...
        with torch.no_grad():
            ...
            if iteration < opt.densify_until_iter:
                ...
                if iteration % 500 == 0 and iteration >= 12000:
                    print('before merge')
    ...
    if iteration in testing_iterations:
        ...
        for config in validation_configs:
            if config['cameras'] and len(config['cameras']) > 0:
                ...
                print("\n[ITER {}] Evaluating {}: L1 {} SSIM {}".format(iteration, config['name'], l1_test, ssim_test))
                print(
                    "\n[ITER {}] Evaluating {}: L1 {} LPIPS {}".format(iteration, config['name'], l1_test, lpips_test))
